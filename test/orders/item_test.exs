defmodule Exlivery.Orders.ItemTest do
  ...
  describe "build/4" do
    test "when all params are valid, returns an item" do
      response = Item.build("Pizza de peperoni", :pizza, "35.5", 3)
    ...
    test "when there is an invalid category, return an error" do
      response = Item.build("Pizza de peperoni", :banana, "35.5", 3)
    ...
    test "when there is an invalid price, returns an error" do
      response = Item.build("Pizza de peperoni", :pizza, "banana_price", 3)
